...
public class HumanTest {
    ...
    public void testPass() {
        ...
        assertEquals(0, testDoc.getNumber());
    }

    @Test
    public void testDate() {
        MyCalendar testDate = new MyCalendar(33, 33, -1995);
        
        assertEquals(0, testDate.getYear());
    }
    @Test
    public void testFullDate() {
        MyCalendar testDate = new MyCalendar(22, 12, 1995);
        String test = "22.12.1995";
        assertSame(test, testDate.getFullDate());
    }
